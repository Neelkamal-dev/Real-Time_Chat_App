...
const ChatContainer = () => {
  ...
  return (
    <div className="h-full flex flex-col justify-between relative backdrop-blur-lg bg-black/10">
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  <div
                    className={`p-3 rounded-2xl break-words text-sm text-white ${
                      isSentByMe
                  ...
                  >
                    {message.image && (
                      <img
                        src={message.image}
                        alt="shared content"
                        className="max-w-[200px] sm:max-w-[280px] rounded-lg mb-2 cursor-pointer border border-gray-700 hover:opacity-90"
                  ...
                  >
                    ...
                    {isSentByMe && (
                      message.seen ? (
                        <span className="text-blue-400 font-bold text-[11px]" title="Seen">✓✓</span>
                      ) : (
      ...
      {imagePreview && (
        <div className="absolute bottom-16 left-4 bg-gray-900 border border-gray-700 p-2 rounded-lg flex items-center gap-2 z-10 shadow-xl">
          <img src={imagePreview} alt="preview" className="h-16 w-16 object-cover rounded" />
          <button
            onClick={handleRemoveImage}
            className="bg-red-500/80 hover:bg-red-600 text-white rounded-full p-1 cursor-pointer text-xs"
          >
            ✕
          </button>
        </div>
      ...
      <form onSubmit={handleSend} className="p-4 flex items-center gap-3">
        <div className="flex-1 flex items-center bg-gray-800/40 px-3 rounded-full border border-gray-700/50">
          <input
            type="text"
            value={text}
          ...
          <label htmlFor="image-file">
            <img
              ...
              alt="gallery"
              className="w-5 mr-1 cursor-pointer hover:opacity-80 transition-all"
            />
          </label>
        </div>
        <button
          ...
          className="cursor-pointer bg-gradient-to-r from-purple-400 to-violet-600 p-2.5 rounded-full hover:opacity-90 active:scale-95 disabled:opacity-40 disabled:pointer-events-none transition-all"
        >
